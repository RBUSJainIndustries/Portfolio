...
st.markdown(f"""
    ...
    .about-us::before {{
        ...
        background-color: rgba(255, 255, 255, 0.75); /* faded white overlay */
        border-radius: 10px;
        z-index: 1;
    }}
    .about-us-content {{
